...
3. Definition of Variable for NR
    ...
    $\mathbf{x} = \begin{bmatrix} \theta_1 \\ \vdots \\ \theta_{N_{pq} + N_{pv}} \\ {|V|}_1 \\ \vdots \\ {|V|}_{N_{pq}} \end{bmatrix}
    \in \mathbb{R}^{2 \times N_{pq} + N_{pv}}, \quad$
    $\mathbf{f(x)} = \begin{bmatrix} P_1 - P_{G_1} + P_{D_1} \\ \vdots \\ P_{N_{pq} + N_{pv}} - P_{G_{N_{pq} + N_{pv}}} + P_{D_{N_{pq} + N_{pv}}} \\ Q_1 - Q_{G_1} + Q_{D_1} \\ \vdots \\ Q_{N_{pq}} - Q_{G_{N_{pq}}} + Q_{D_{N_{pq}}} \end{bmatrix}
    \in \mathbb{R}^{2 \times N_{pq} + N_{pv}}$
